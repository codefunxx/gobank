...
function Hero() {
  return (
    <div className="relative w-full bg-cover bg-no-repeat bg_img" style={{backgroundImage: `url("/image/bg2.jpg")`}}>
      <div>
        <header className="grid !min-h-[16rem] px-8">
          <div className="container mx-auto mt-10 grid h-full w-full grid-cols-1 place-items-center lg:mt-14 lg:grid-cols-1">
            <div className="col-span-1 z-40 justify-center">
              ...
              >
                <p className="banner-content__subtitle text-[12px] text-center">
                  CHẴN LẺ BANK - CHẴN LẺ ZALO - CHẴN LẺ MOMO - TÀI XỈU TELEGRAM - THANH TOÁN 3 GIÂY</p>
              </Typography>
            </div>
          </div>
        </header>
